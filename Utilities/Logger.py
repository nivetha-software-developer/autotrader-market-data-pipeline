...
class Logger:
    ...
    def __init__(self, automation_name: str, root_folder: str, todayDate):
        ...
        self.log_file_name = os.path.join(log_foler_path, f'{automation_name}_{todayDate}.log')
        logging.basicConfig(filename=self.log_file_name, level=logging.INFO, filemode="w",
    ...
    _COLORS = {
        ...
        'warning': 33,  # Yellow
        'info': 36,  # Cyan
        'waiting': 34  # Blue (or 33 for yellow)
    }
...
if __name__ == "__main__":
    logger_man = Logger('Test', r'D:\Mans_Group')
    ...
    logger('Waiting', logger_man.WAITING)
